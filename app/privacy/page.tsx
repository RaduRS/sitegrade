      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="space-y-8">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">1. Who We Are</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">2. Information We Collect</h2>
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-white">Website URLs</h3>
                ...
                <h3 className="text-xl font-semibold text-white">Analytics Data</h3>
                <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">3. How We Use Your Information</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">4. Public Reviews and Content</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">5. Data Sharing and Disclosure</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">6. Data Retention</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">7. Your Rights</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">8. Security</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">9. International Transfers</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">10. Changes to This Policy</h2>
              <p className="text-gray-300">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-amber-400">11. Contact Us</h2>
              <p className="text-gray-300">
