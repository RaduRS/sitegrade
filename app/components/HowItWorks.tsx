...
function StepCard({
  ...
  if (stepIndex === 2) {
    return (
      <article
        className="text-center pt-6 md:pt-8 px-6 md:px-8 pb-2 md:pb-4 how-it-works-card h-full flex flex-col"
      ...
      >
        ...
        <h3 id={`step-title-${stepIndex}`} className="heading-sm mb-4 md:mb-6">
          {title}
        </h3>
        <div className="flex-1 flex flex-col">
          <p
            id={`step-desc-${stepIndex}`}
            className="body-sm text-slate-300 mb-4"
          >
            {description}
          </p>
        </div>
  ...
  return (
    <article
      className="text-center p-6 md:p-8 how-it-works-card h-full flex flex-col"
      aria-labelledby={`step-title-${stepIndex}`}
      aria-describedby={`step-desc-${stepIndex}`}
    >
      <div
      ...
      <div className="flex-1">
        <p id={`step-desc-${stepIndex}`} className="body-sm text-slate-300">
          {renderDescription()}
        </p>
      </div>
    </article>
...
export default function HowItWorks({
  ...
  return (
    <section
      ...
      role="region"
      aria-label="How to get your instant website audit report"
    >
      <div
